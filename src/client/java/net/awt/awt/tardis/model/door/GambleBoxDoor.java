...
public class GambleBoxDoor extends DoorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Body = modelPartData.addChild("Body", ModelPartBuilder.create().uv(84, 27).cuboid(-11.7651F, -42.1386F, -11.7651F, 2.6145F, 39.5242F, 2.6145F, new Dilation(0.0F))
		.uv(136, 0).cuboid(-11.1115F, -41.485F, -12.4187F, 22.2229F, 2.2681F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 27.0F, 3.0F));

		ModelPartData cube_r1 = Body.addChild("cube_r1", ModelPartBuilder.create().uv(90, 129).cuboid(-11.7651F, -42.1386F, -11.7651F, 2.6145F, 39.5242F, 2.6145F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData Doors = Body.addChild("Doors", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData right_door = Doors.addChild("right_door", ModelPartBuilder.create().uv(34, 129).cuboid(-1.1762F, -20.3328F, -0.3268F, 10.0F, 37.0F, 0.6536F, new Dilation(0.0F))
		.uv(72, 129).cuboid(0.4774F, -19.2817F, -0.6536F, 9.0F, 35.9489F, 0.0F, new Dilation(0.0F))
		...
		ModelPartData left_door = Doors.addChild("left_door", ModelPartBuilder.create().uv(54, 129).cuboid(-8.8238F, -20.3328F, -0.3268F, 9.0F, 37.0F, 0.6536F, new Dilation(0.0F))
