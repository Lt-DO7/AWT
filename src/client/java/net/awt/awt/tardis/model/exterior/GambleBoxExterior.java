...
public class GambleBoxExterior extends ExteriorModel {
	private ModelPart left_door;
	private ModelPart right_door;
	private ModelPart Posts;
	private ModelPart Walls;
	private ModelPart PCB;
	private ModelPart Roof;
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(80, 50).cuboid(-8.1702F, -6.863F, -0.9804F, 0.6536F, 2.6145F, 0.6536F, new Dilation(0.0F)), ModelTransform.pivot(8.8238F, 5.7183F, -10.131F));
		...
		.uv(80, 54).cuboid(6.2094F, -6.2093F, -0.9804F, 0.6536F, 1.3072F, 0.6536F, new Dilation(0.0F)), ModelTransform.pivot(-8.8238F, 5.7183F, -10.131F));

		ModelPartData Posts = modelPartData.addChild("Posts", ModelPartBuilder.create().uv(84, 27).cuboid(-11.7651F, -42.1386F, -11.7651F, 2.6145F, 39.5242F, 2.6145F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 25.0F, 0.0F));
		...
		ModelPartData Walls = modelPartData.addChild("Walls", ModelPartBuilder.create().uv(0, 71).cuboid(-10.4579F, -42.2169F, -9.1506F, 0.6536F, 39.6025F, 18.3012F, new Dilation(0.0F))
		...
		.uv(142, 16).cuboid(-9.1506F, -39.2169F, -10.7847F, 0.6536F, 36.6025F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 25.0F, 0.0F));
		...
		ModelPartData PCB = modelPartData.addChild("PCB", ModelPartBuilder.create().uv(136, 0).cuboid(-11.1115F, -40.8314F, -12.4187F, 22.2229F, 2.2681F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.3464F, 0.0F));
		...
		ModelPartData Roof = modelPartData.addChild("Roof", ModelPartBuilder.create().uv(0, 27).cuboid(-10.4579F, -42.4459F, -10.4579F, 20.9157F, 1.6145F, 20.9157F, new Dilation(0.0F))
		...
		.uv(144, 21).cuboid(-1.0392F, -48.7284F, -0.9608F, 2.0F, 1.4F, 1.9217F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.3464F, 0.0F));
		...
		ModelPartData bb_main = modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(0, 0).cuboid(-12.4187F, -1.6145F, -12.4187F, 24.8374F, 1.6145F, 24.8374F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
	...
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		...
		Roof.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	...
	public void renderWithAnimations(ClientTardis tardis, ExteriorBlockEntity exterior, ModelPart root, MatrixStack matrices,
		...
		if (!AITMod.CONFIG.CLIENT.ANIMATE_DOORS) {
			this.left_door.getChild("left_door").yaw = (door.isLeftOpen() || door.isOpen()) ? -5.0F : 0.0F;
			this.right_door.getChild("right_door").yaw = (door.isRightOpen() || door.areBothOpen())
					? 5.0F
					: 0.0F;
		} else {
			float maxRot = 90f;
			this.left_door.getChild("left_door").yaw = (float) Math.toRadians(maxRot * door.getLeftRot());
			this.right_door.getChild("right_door").yaw = (float) -Math.toRadians(maxRot * door.getRightRot());
		}
